...
import { useDeleteBoardMutation } from '../../hooks/useDeleteBoard';
...
export function DeleteBoardDialog({ id, name }: DeleteBoardDialogProps) {
  ...
  const handleDeleteBoard = useCallback(
    ...
    [mutation, notificationLoading]
  );

  const onModalChange = () => !mutation.isPending && setIsOpen((prev) => !prev);
  ...
  }, [mutation.isSuccess, queryClient, setActiveBoard]);
